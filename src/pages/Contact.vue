  ...
  methods: {
    async submitForm() {
      ...
      setTimeout(() => {
        ...
        this.submitMessage = 'Thank you for contacting us! We\'ll respond within 24 hours.';
        this.resetForm();
      }, 2000);
    },
    validateForm() {
      const required = ['firstName', 'lastName', 'email', 'phone', 'department', 'subject', 'message'];
          ...
          <div class="col-lg-3 col-md-6">
            <div class="card border-0 h-100 shadow-sm hover-card">
              <div class="card-body text-center p-4">
                ...
                <a :href="`tel:${contactInfo.emergencyPhone}`" class="text-decoration-none fw-semibold text-danger">{{ contactInfo.emergencyPhone }}</a>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="card border-0 h-100 shadow-sm hover-card">
              <div class="card-body text-center p-4">
                ...
                <a :href="`tel:${contactInfo.phone}`" class="text-decoration-none fw-semibold text-primary">{{ contactInfo.phone }}</a>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="card border-0 h-100 shadow-sm hover-card">
              <div class="card-body text-center p-4">
                ...
                <a :href="`mailto:${contactInfo.email}`" class="text-decoration-none fw-semibold text-success">{{ contactInfo.email }}</a>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-md-6">
            <div class="card border-0 h-100 shadow-sm hover-card">
              <div class="card-body text-center p-4">
                ...
                <p class="fw-semibold text-warning small">{{ contactInfo.address }}</p>
              </div>
            </div>
          </div>
        </div>
          ...
          <div class="col-lg-8">
            <div class="card border-0 shadow-sm">
              <div class="card-body p-5">
                ...
                <!-- Success Message -->
                <div v-if="submitSuccess" class="alert alert-success d-flex align-items-center mb-4">
                ...
                <form @submit.prevent="submitForm">
                  <div class="row g-3">
                    ...
                    <div class="col-md-6">
                      ...
                      <select class="form-select form-select-lg" id="urgency" v-model="form.urgency">
                    ...
                    <div class="col-12">
                      ...
                      >
                        ...
                        <i v-if="!isSubmitting" class="bi bi-arrow-right ms-2"></i>
                      </button>
                    </div>
                  </div>
                </form>
          ...
          <div class="col-lg-4">
            ...
            <div class="card border-0 shadow-sm mb-4">
              <div class="card-body p-4">
                ...
                <div class="space-y-3">
                  <div v-for="(schedule, index) in businessHours" :key="index" class="d-flex justify-content-between align-items-center py-2" :class="{ 'border-bottom': index < businessHours.length - 1 }">
                    <span class="fw-semibold text-muted">{{ schedule.day }}</span>
                    <span class="text-primary fw-semibold">{{ schedule.hours }}</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div class="card border-0 shadow-sm mb-4">
              <div class="card-body p-4">
                ...
                <div class="d-grid gap-2">
                  <a :href="`tel:${contactInfo.emergencyPhone}`" class="btn btn-danger">
      ...
      <div class="container-fluid px-md-5 px-3">
        <div class="row">
          <div class="col-12">
            ...
            <div class="map-container position-relative rounded-4 overflow-hidden shadow">
              <!-- Placeholder for Google Maps - you can replace this with actual Google Maps embed -->
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3964.681049111506!2d3.3792057!3d6.4376019!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x103bf4d948bb1ce3%3A0x7db7a93b65aacb24!2sLagos%2C%20Nigeria!5e0!3m2!1sen!2s!4v1697720000000!5m2!1sen!2s"
                width="100%"
                height="400"
                style="border:0;"
                allowfullscreen=""
              ...
              <div class="position-absolute top-0 start-0 m-4">
                <div class="card border-0 shadow">
                  <div class="card-body p-3">
                    ...
                    <p class="text-muted small mb-0">{{ contactInfo.address }}</p>
                  </div>
                </div>
              </div>
            </div>
